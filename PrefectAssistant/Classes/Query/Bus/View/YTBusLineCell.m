...
- (instancetype)initWithStyle:(UITableViewCellStyle)style reuseIdentifier:(NSString *)reuseIdentifier {
    ...
    CALayer *layerLine = [[CALayer alloc] init]; {
        [layerLine setFrame:CGRectMake(YTSCREEN_W/3-20, 0, 1, YTBusLineHeight)];
    ...
    UILabel *stationNumLabel = [[UILabel alloc] init]; {
        ...
        [stationNumLabel setFont:[UIFont systemFontOfSize:14]];
        [stationNumLabel setTextColor:YTColorGrayText];
    }
    ...
    UILabel *nameLabel = [[UILabel alloc] init]; {
        ...
        [nameLabel setTextColor:YTColorGrayText];
    }
